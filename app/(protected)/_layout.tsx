 ...
 * uma rota protegida (ex: deep link). O index.tsx já faz a verificação inicial,
 * mas esta verificação garante que mesmo acessos diretos sejam protegidos.
 */
export default function ProtectedLayout() {
  ...
  if (error) {
    console.error("⚠️ [ProtectedLayout] Erro ao verificar onboarding:", error);
    // Continuar renderizando, mas o erro será tratado pela página
  }

  // Tudo ok, renderizar as tabs protegidas
  console.log("✅ [ProtectedLayout] Usuário autenticado e onboarding completo");
  return (
    <Tabs
      screenOptions={{
